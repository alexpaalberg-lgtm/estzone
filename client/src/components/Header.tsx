        ...
        <div className="flex h-14 items-center gap-1">
          ...
          <div className="flex items-center gap-1 sm:gap-1 ml-auto mr-3 sm:mr-0">
            ...
            <Button
              variant="ghost"
              size="icon"
              className="lg:hidden h-9 w-9 sm:h-10 sm:w-10 ml-4 mr-2 sm:ml-0 sm:mr-0"
              ...
              <Link href="/wishlist">
                ...
                >
                  ...
                  {wishlistItems && wishlistItems.length > 0 && (
                    <Badge
                      variant="default"
                      className="absolute -top-1 -right-1 h-4 w-4 sm:h-5 sm:w-5 flex items-center justify-center p-0 text-[9px] sm:text-[10px]"
