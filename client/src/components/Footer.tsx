          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            ...
            <div>
              ...
              <div className="flex items-center gap-6 md:gap-4">
                <SiStripe className="h-10 w-10 md:h-6 md:w-6 text-primary" />
                <SiVisa className="h-10 w-10 md:h-6 md:w-6 text-muted-foreground" />
                <SiMastercard className="h-10 w-10 md:h-6 md:w-6 text-muted-foreground" />
                <span className="text-lg md:text-xs font-semibold text-muted-foreground">Paysera</span>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex items-center gap-6 md:gap-4">
                <span className="text-lg md:text-xs font-semibold text-muted-foreground">Omniva</span>
                <span className="text-lg md:text-xs font-semibold text-muted-foreground">DPD</span>
                <span className="text-lg md:text-xs font-semibold text-muted-foreground">DHL</span>
              </div>
            </div>
            ...
            <div>
              ...
              <a 
                ...
                className="text-lg md:text-sm text-muted-foreground hover:text-primary transition-colors"
